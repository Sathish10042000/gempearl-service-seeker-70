        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button className="bg-gempearl-teal hover:bg-gempearl-gold hover:text-gempearl-navy text-white font-medium px-6 py-3 rounded-md text-lg">
                Get Started
            ...
            <div className="mt-12 grid grid-cols-2 md:grid-cols-3 gap-6">
              <div className="flex items-center">
                <div className="bg-gempearl-teal/20 p-2 rounded-full">
                  <div className="bg-gempearl-teal h-10 w-10 rounded-full flex items-center justify-center text-white font-bold">
                    10+
                  </div>
                </div>
                <div className="ml-3">
          ...
          <div className="hidden lg:block relative">
            <div className="relative z-10 bg-white p-6 rounded-lg shadow-xl">
              <h3 className="text-gempearl-navy text-xl font-semibold mb-4">Request a Free Consultation</h3>
              <form className="space-y-4">
                ...
                <div>
                  <select className="w-full px-4 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-gempearl-teal">
                ...
                <Button className="w-full bg-gempearl-teal hover:bg-gempearl-navy text-white py-3">
